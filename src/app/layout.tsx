...
export const metadata: Metadata = {
  title: "Roma Luxury Hotel | 5-Star Accommodation in Rome",
  description: "Experience luxury hospitality in the heart of Rome. Award-winning service, fine dining, spa facilities, and prime location near historic attractions.",
  keywords: "luxury hotel Rome, 5-star accommodation, Colosseum hotel, Italian hospitality",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Roma Luxury Hotel | Premium Stay in Rome",
    description: "Discover timeless elegance and exceptional service at our luxury hotel in the historic center of Rome.",
    type: "website",
    siteName: "Roma Luxury Hotel",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764094763383-undykglx.jpg",
        alt: "Roma Luxury Hotel - Rome Colosseum View"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Roma Luxury Hotel | 5-Star Stay in Rome",
    description: "Experience luxury hospitality steps from the Colosseum and historic Rome attractions.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764094763383-undykglx.jpg"]
  }
};
